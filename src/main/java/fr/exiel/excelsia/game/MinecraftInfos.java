...
public class MinecraftInfos {
    ...
    public static final String LAUNCHER_VERSION = "1.2.1";
    ...
    public static final String FORGE_VERSION = "1.16.5-36.2.31";
    ...
    public static final String CURSE_MODS_LIST_URL = "http://ftp.exiel.fr/mods_list.json";
    public static final String LAUNCHER_OPTIONS_URL = "http://ftp.exiel.fr/options.json";
}
